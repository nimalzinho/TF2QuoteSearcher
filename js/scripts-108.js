$(document).ready(function () {
    ...
    function searchForQuotes() {
        ...
        let url = "./json/" + characterJson;
        
        // remove this later!
        let urlTest = "https://nimalzinho.github.io/TF2QuoteSearcher/json/" + characterJson;

        $.getJSON(urlTest, function (data) {
